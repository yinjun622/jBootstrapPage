    ...
    $.fn.jBootstrapPage = function(config) {
        ...
        return this.each(function() {
            ...
            function init() {
                ...
                c.maxPageButton = c.maxPages < c.maxPageButton ? c.maxPages : c.maxPageButton;
            ...
            function onPageBtnClick($_this) {
            	...
            	if(selectedText == '下一页') {
                    ...
                    mathNextPage(c.maxPageButton-1, c.maxPages, c.maxPages, c.maxPageButton);
                    selectedBtn = $this.find('li.page').find('a[page="'+(c.maxPages)+'"]');
                }
                else if(selectedText == '«'){
                    mathPrePage(2, 1, c.maxPages, c.maxPageButton);
